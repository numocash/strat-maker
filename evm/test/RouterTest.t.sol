...
//         "Transfer(TransferDetails transferDetails,address spender)TransferDetails(bytes32 id,uint8 orderType,uint128
// amount)"
//     );
...
//                     keccak256(
//                         abi.encode(
//                             VERIFY_TYPEHASH, keccak256(abi.encodePacked(verify.dataHash)), verify.nonce,
// verify.deadline
//                         )
//                     )
//                 )
...
//             borrowLiquidityCommand(address(token0), address(token1), 0, 0, Engine.TokenSelector.Token0, 1e18,
// 0.5e18);
