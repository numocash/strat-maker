...
//         (uint256 amount0, uint256 amount1) = calcAmountsForLiquidity(tickCurrent, 0, tickLower, tickUpper,
// liquidity);
//         assertEq(amount0, 0);
...
//             calcAmountsForLiquidity(tickCurrent, uint128(Q128 / 2), tickLower, tickUpper, liquidity);
//         assertEq(amount0, mulDiv(liquidity, Q128 / 2, Q128));
//         assertEq(amount1, mulDiv(liquidity, Q128 / 2, Q128));
//     }
...
//         assertEq(amount0, mulDiv(liquidity, (type(uint128).max - composition), getRatioAtTick(1)));
...
//         assertEq(
//             amount0,
//             mulDiv(liquidity, (Q128 - composition) * Q128, getRatioAtTick(1) * Q128)
//                 + mulDiv(liquidity, Q128, getRatioAtTick(2))
//         );
//         assertEq(amount1, mulDiv(liquidity, composition, Q128) + liquidity);
//     }
// }
